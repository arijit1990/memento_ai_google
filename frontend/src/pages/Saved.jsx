              ...
              >
                ...
                <div className="p-4 flex items-start justify-between gap-3">
                  <div>
                    ...
                    <h3 className="font-serif text-lg text-memento-espresso leading-tight tracking-tight">
                      {item.title}
                    </h3>
                    <p className="text-xs text-memento-coffee mt-1">
                      {item.location}
                    </p>
                  </div>
                  <button
...
const EmptySaved = () => (
  <div className="text-center py-20">
    ...
    <p className="text-memento-coffee max-w-sm mx-auto">
      Tap the heart on any place, hotel, or activity in your itinerary to keep
      it here.
    </p>
  </div>
);
